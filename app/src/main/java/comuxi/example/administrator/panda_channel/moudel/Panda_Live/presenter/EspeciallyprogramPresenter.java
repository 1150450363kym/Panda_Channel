...
public class EspeciallyprogramPresenter implements EspeciallyprogramPresenterContract.presenter {

    private EspeciallyprogramPresenterContract.View oneView;
    private PandaMode pandaMode;

    public EspeciallyprogramPresenter(EspeciallyprogramPresenterContract.View oneView){
