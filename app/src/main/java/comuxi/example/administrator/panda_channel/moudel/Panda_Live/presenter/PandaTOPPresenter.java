...
public class PandaTOPPresenter implements PandaTOPContract.presenter {

    private PandaTOPContract.View oneView;
    private PandaMode pandaMode;

    public PandaTOPPresenter(PandaTOPContract.View oneView){
