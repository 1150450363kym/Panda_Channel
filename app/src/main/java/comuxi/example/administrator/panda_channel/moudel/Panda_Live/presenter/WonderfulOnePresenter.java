...
public class WonderfulOnePresenter implements WonderfuloneContract.presenter{

    private WonderfuloneContract.View oneView;
    private PandaMode pandaMode;

    public WonderfulOnePresenter(WonderfuloneContract.View oneView){
