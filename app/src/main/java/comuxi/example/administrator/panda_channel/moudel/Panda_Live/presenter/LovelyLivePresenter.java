...
public class LovelyLivePresenter implements LovelyLiveContract.presenter {

    private LovelyLiveContract.View oneView;
    private PandaMode pandaMode;

    public LovelyLivePresenter(LovelyLiveContract.View oneView){
