...
public class PandaThingPresenter implements PandaThingContract.presenter {

    private PandaThingContract.View oneView;
    private PandaMode pandaMode;

    public PandaThingPresenter(PandaThingContract.View oneView){
